...
(defvar CL-USER::*LOAD-SOURCE-PATHNAME-TYPES*)
(defvar CL-USER::*LOAD-BINARY-PATHNAME-TYPES*)
(defvar CL-USER::*zebu-directory*)
(defvar CL-USER::*zebu-binary-directory*)
...
(defparameter zb:*zebu-version*
  #.(let ((file (make-pathname :name "VERSION" :type nil :version nil
