...
(defconst LEFTWARD_ARROW 342896)
...
(setq lse-default-font-lock
      ...
      (append 
       ...
       '(
         ...
         ;; left arrow
         ("_" (1 (prog1 nil (compose-region (match-beginning 0) (match-end 0)
                                            LEFTWARD_ARROW 'decompose-region))))
         ;; line numbers:
         ("^\\([0-9]+\\)"
...
;;;; lse-mode.el                      -- 2003-01-31 23:03:24 -- pascal   ;;;;
