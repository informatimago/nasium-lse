...
(DEFUN INTERVALE-DE-NUMEROS763 (NUMERO-DE-LIGNE.1
                                TOK-A
                                NUMERO-DE-LIGNE.2)
...
(DEFUN INTERVALE-DE-NUMEROS764 (NUMERO-DE-LIGNE)
  (PROGN NUMERO-DE-LIGNE))

(DEFUN LISTE-D-INTERVALES764 (INTERVALE-DE-NUMEROS
                              TOK-VIRGULE
                              LISTE-D-INTERVALES)
  (DECLARE (IGNORE TOK-VIRGULE))
  (CONS INTERVALE-DE-NUMEROS LISTE-D-INTERVALES))

(DEFUN LISTE-D-INTERVALES765 (INTERVALE-DE-NUMEROS)
  (LIST INTERVALE-DE-NUMEROS))

(DEFUN LISTE-DE-NUMEROS765 (TOK-FOIS)
  (DECLARE (IGNORE TOK-FOIS))
  (PROGN :ALL))

(DEFUN LISTE-DE-NUMEROS766 () (PROGN NIL))
