...
(DEFUN INTERVALE-DE-NUMEROS553 (NUMERO-DE-LIGNE.1
                                TOK-A
                                NUMERO-DE-LIGNE.2)
...
(DEFUN INTERVALE-DE-NUMEROS554 (NUMERO-DE-LIGNE)
  (PROGN NUMERO-DE-LIGNE))

(DEFUN LISTE-D-INTERVALES554 (INTERVALE-DE-NUMEROS
                              TOK-VIRGULE
                              LISTE-D-INTERVALES)
  (DECLARE (IGNORE TOK-VIRGULE))
  (CONS INTERVALE-DE-NUMEROS LISTE-D-INTERVALES))

(DEFUN LISTE-D-INTERVALES555 (INTERVALE-DE-NUMEROS)
  (LIST INTERVALE-DE-NUMEROS))

(DEFUN LISTE-DE-NUMEROS555 (TOK-FOIS)
  (DECLARE (IGNORE TOK-FOIS))
  (PROGN :ALL))

(DEFUN LISTE-DE-NUMEROS556 () (PROGN NIL))
