...
(DEFUN DEUX-NUMEROS223 (TOK-NUMERO.1 TOK-VIRGULE TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-VIRGULE))
  (PROGN (LIST TOK-NUMERO.1 TOK-NUMERO.2)))

(DEFUN IDENT224 (TOK-IDENTIFICATEUR)
...
(DEFUN UN-FICHIER-ET-DEUX-NUMEROS224 (IDENT TOK-VIRGULE DEUX-NUMEROS)
  (DECLARE (IGNORE TOK-VIRGULE))
