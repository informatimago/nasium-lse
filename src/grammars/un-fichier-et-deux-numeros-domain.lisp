...
(DEFUN DEUX-NUMEROS767 (TOK-NUMERO.1 TOK-VIRGULE TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-VIRGULE))
  (PROGN (LIST TOK-NUMERO.1 TOK-NUMERO.2)))

(DEFUN IDENT768 (TOK-IDENTIFICATEUR)
...
(DEFUN UN-FICHIER-ET-DEUX-NUMEROS768 (IDENT TOK-VIRGULE DEUX-NUMEROS)
  (DECLARE (IGNORE TOK-VIRGULE))
