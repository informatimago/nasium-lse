...
(DEFUN EXECUTER/1218 (TOK-EXECUTER EXPRESSION)
  (DECLARE (IGNORE TOK-EXECUTER))
  (LIST :EXECUTER EXPRESSION))

(DEFUN EXECUTER218 (EXECUTER/1 TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC EXECUTER/1 EXPRESSION))

(DEFUN SUPPRIMER/1218 (TOK-SUPPRIMER EXPRESSION)
  (DECLARE (IGNORE TOK-SUPPRIMER))
  (LIST :SUPPRIMER EXPRESSION))

(DEFUN SUPPRIMER218 (SUPPRIMER/1 TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC SUPPRIMER/1 EXPRESSION))

(DEFUN CHARGER/1218 (TOK-CHARGER IDENTIFICATEUR TOK-VIRGULE
...
(DEFUN CHARGER218 (CHARGER/1 TOK-VIRGULE IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC CHARGER/1 IDENTIFICATEUR))

(DEFUN GARER218 (TOK-GARER IDENTIFICATEUR TOK-VIRGULE EXPRESSION.1
...
(DEFUN APPEL/1218 (IDENTIFICATEUR TOK-PARGAUCHE)
  (DECLARE (IGNORE TOK-PARGAUCHE))
  (LIST :APPEL IDENTIFICATEUR))

(DEFUN APPEL218 (APPEL/1 LISTE-EXPRESSION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (NCONC APPEL/1 LISTE-EXPRESSION))

(DEFUN APPEL219 (APPEL/1 TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (PROGN APPEL/1))

(DEFUN RESULTAT219 (TOK-RESULTAT EXPRESSION)
  (DECLARE (IGNORE TOK-RESULTAT))
  (LIST :RESULTAT EXPRESSION))

(DEFUN RETOUR219 (TOK-RETOUR)
  (DECLARE (IGNORE TOK-RETOUR))
  (LIST :RETOUR))

(DEFUN RETOUR220 (TOK-RETOUR TOK-EN EXPRESSION)
  (DECLARE (IGNORE TOK-RETOUR TOK-EN))
  (LIST :RETOUR-EN EXPRESSION))

(DEFUN FAIRE-POUR220 (TOK-FAIRE TOK-NUMERO TOK-POUR IDENTIFICATEUR
                      TOK-FLECHE EXPRESSION)
  (DECLARE (IGNORE TOK-FAIRE TOK-POUR TOK-FLECHE))
  (LIST TOK-NUMERO IDENTIFICATEUR EXPRESSION))

(DEFUN FAIRE-POUR-PAS220 (FAIRE-POUR TOK-PAS EXPRESSION)
  (DECLARE (IGNORE TOK-PAS))
  (SNOC FAIRE-POUR EXPRESSION))

(DEFUN FAIRE-POUR-PAS221 (FAIRE-POUR) (SNOC FAIRE-POUR NIL))

(DEFUN FAIRE-TANT-QUE221 (FAIRE-POUR-PAS TOK-TANT TOK-QUE
                          DISJONCTION)
  (DECLARE (IGNORE TOK-TANT TOK-QUE))
  (CONS :FAIRE-TANT-QUE (SNOC FAIRE-POUR-PAS DISJONCTION)))

(DEFUN FAIRE-JUSQU-A221 (FAIRE-POUR-PAS TOK-JUSQUA EXPRESSION)
  (DECLARE (IGNORE TOK-JUSQUA))
  (CONS :FAIRE-JUSQU-A (SNOC FAIRE-POUR-PAS EXPRESSION)))

(DEFUN DEBUT-FIN221 (TOK-DEBUT LISTE-INST-OU-DECL TOK-FIN)
  (DECLARE (IGNORE TOK-DEBUT TOK-FIN))
  (CONS :DEBUT LISTE-INST-OU-DECL))

(DEFUN PAUSE221 (TOK-PAUSE)
  (DECLARE (IGNORE TOK-PAUSE))
  (LIST :PAUSE))

(DEFUN TERMINER221 (TOK-TERMINER)
  (DECLARE (IGNORE TOK-TERMINER))
  (LIST :TERMINER))

(DEFUN SI-ALORS221 (TOK-SI DISJONCTION TOK-ALORS INSTRUCTION)
  (DECLARE (IGNORE TOK-SI TOK-ALORS))
  (LIST :SI DISJONCTION INSTRUCTION))

(DEFUN SI-ALORS-SINON221 (SI-ALORS TOK-SINON INSTRUCTION)
  (DECLARE (IGNORE TOK-SINON))
  (SNOC SI-ALORS INSTRUCTION))

(DEFUN ALLER-EN221 (TOK-ALLER TOK-EN EXPRESSION)
  (DECLARE (IGNORE TOK-ALLER TOK-EN))
  (LIST :ALLER-EN EXPRESSION))

(DEFUN SPEC-REP221 (TOK-FOIS)
  (DECLARE (IGNORE TOK-FOIS))
  (LIST :REP-VAR))

(DEFUN SPEC-REP-NUM221 (TOK-NUMERO) (LIST :REP TOK-NUMERO))

(DEFUN SPECIFICATION221 (TOK-LITCHAINE)
  (LIST :SPEC-CHAINE '(:REP-1) TOK-LITCHAINE))

(DEFUN SPECIFICATION222 (TOK-DIVISE)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :SPEC-SLASH '(:REP-1)))

(DEFUN SPECIFICATION223 (TOK-X)
  (DECLARE (IGNORE TOK-X))
  (LIST :SPEC-SPACE '(:REP-1)))

(DEFUN SPECIFICATION224 (TOK-C)
  (DECLARE (IGNORE TOK-C))
  (LIST :SPEC-CR '(:REP-1)))

(DEFUN SPECIFICATION225 (TOK-L)
  (DECLARE (IGNORE TOK-L))
  (LIST :SPEC-NL '(:REP-1)))

(DEFUN SPECIFICATION226 (TOK-U)
  (DECLARE (IGNORE TOK-U))
  (LIST :SPEC-U '(:REP-1)))

(DEFUN SPECIFICATION227 (TOK-F TOK-NUMERO.1 TOK-POINT TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-F TOK-POINT))
  (LIST :SPEC-F '(:REP-1) TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION228 (TOK-E TOK-NUMERO.1 TOK-POINT TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-E TOK-POINT))
  (LIST :SPEC-E '(:REP-1) TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION229 (SPEC-REP TOK-LITCHAINE)
  (LIST :SPEC-CHAINE SPEC-REP TOK-LITCHAINE))

(DEFUN SPECIFICATION230 (SPEC-REP TOK-DIVISE)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :SPEC-SLASH SPEC-REP))

(DEFUN SPECIFICATION231 (SPEC-REP TOK-X)
  (DECLARE (IGNORE TOK-X))
  (LIST :SPEC-SPACE SPEC-REP))

(DEFUN SPECIFICATION232 (SPEC-REP TOK-C)
  (DECLARE (IGNORE TOK-C))
  (LIST :SPEC-CR SPEC-REP))

(DEFUN SPECIFICATION233 (SPEC-REP TOK-L)
  (DECLARE (IGNORE TOK-L))
  (LIST :SPEC-NL SPEC-REP))

(DEFUN SPECIFICATION234 (SPEC-REP-NUM TOK-U)
  (DECLARE (IGNORE TOK-U))
  (LIST :SPEC-U SPEC-REP-NUM))

(DEFUN SPECIFICATION235 (SPEC-REP-NUM TOK-F TOK-NUMERO.1 TOK-POINT
                         TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-F TOK-POINT))
  (LIST :SPEC-F SPEC-REP-NUM TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION236 (SPEC-REP-NUM TOK-E TOK-NUMERO.1 TOK-POINT
                         TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-E TOK-POINT))
  (LIST :SPEC-E SPEC-REP-NUM TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN LISTE-SPEC236 (LISTE-SPEC TOK-VIRGULE SPECIFICATION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-SPEC SPECIFICATION))

(DEFUN LISTE-SPEC237 (SPECIFICATION) (LIST SPECIFICATION))

(DEFUN FORMAT237 (TOK-CROGAUCHE LISTE-SPEC TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CROGAUCHE TOK-CRODROITE))
  (PROGN LISTE-SPEC))

(DEFUN AFFICHER/FORMAT237 (TOK-AFFICHER FORMAT)
  (DECLARE (IGNORE TOK-AFFICHER))
  (LIST :AFFICHER FORMAT))

(DEFUN AFFICHER237 (TOK-AFFICHER LISTE-EXPRESSION)
  (DECLARE (IGNORE TOK-AFFICHER))
  (LIST* :AFFICHER NIL LISTE-EXPRESSION))

(DEFUN AFFICHER238 (AFFICHER/FORMAT LISTE-EXPRESSION)
  (NCONC AFFICHER/FORMAT LISTE-EXPRESSION))

(DEFUN LIRE238 (TOK-LIRE LISTE-REFERENCE)
  (DECLARE (IGNORE TOK-LIRE))
  (CONS :LIRE LISTE-REFERENCE))

(DEFUN AFFECTATION238 (REFERENCE TOK-FLECHE EXPRESSION)
  (DECLARE (IGNORE TOK-FLECHE))
  (LIST :AFFECTATION REFERENCE EXPRESSION))

(DEFUN LISTE-REFERENCE238 (LISTE-REFERENCE TOK-VIRGULE REFERENCE)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-REFERENCE REFERENCE))

(DEFUN LISTE-REFERENCE239 (REFERENCE) (LIST REFERENCE))

(DEFUN REFERENCE/VECTEUR239 (IDENTIFICATEUR TOK-CROGAUCHE EXPRESSION)
  (DECLARE (IGNORE TOK-CROGAUCHE))
  (LIST :AREF IDENTIFICATEUR EXPRESSION))

(DEFUN REFERENCE239 (REFERENCE/VECTEUR TOK-VIRGULE EXPRESSION
                     TOK-CRODROITE)
  (DECLARE (IGNORE TOK-VIRGULE TOK-CRODROITE))
  (SNOC REFERENCE/VECTEUR EXPRESSION))

(DEFUN REFERENCE240 (REFERENCE/VECTEUR TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CRODROITE))
  (PROGN REFERENCE/VECTEUR))

(DEFUN REFERENCE241 (IDENTIFICATEUR) (LIST :VREF IDENTIFICATEUR))

(DEFUN DECL-LOCAL241 (TOK-LOCAL LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-LOCAL))
  (PROGN LISTE-IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/TETE241 (TOK-PROCEDURE
                               IDENTIFICATEUR
                               TOK-PARGAUCHE)
  (DECLARE (IGNORE TOK-PROCEDURE TOK-PARGAUCHE))
  (LIST :PROCEDURE IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/N241 (DECL-PROCEDURE/TETE LISTE-IDENTIFICATEUR
                            TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (SNOC DECL-PROCEDURE/TETE LISTE-IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/0241 (DECL-PROCEDURE/TETE TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (SNOC DECL-PROCEDURE/TETE NIL))

(DEFUN DECL-PROCEDURE241 (DECL-PROCEDURE/0)
  (SNOC DECL-PROCEDURE/0 NIL))

(DEFUN DECL-PROCEDURE242 (DECL-PROCEDURE/0 DECL-LOCAL)
  (SNOC DECL-PROCEDURE/0 DECL-LOCAL))

(DEFUN DECL-PROCEDURE243 (DECL-PROCEDURE/N)
  (SNOC DECL-PROCEDURE/N NIL))

(DEFUN DECL-PROCEDURE244 (DECL-PROCEDURE/N DECL-LOCAL)
  (SNOC DECL-PROCEDURE/N DECL-LOCAL))

(DEFUN DECL-TABL/1244 (IDENTIFICATEUR TOK-CROGAUCHE EXPRESSION)
  (DECLARE (IGNORE TOK-CROGAUCHE))
  (LIST :ADECL IDENTIFICATEUR EXPRESSION))

(DEFUN DECL-TABL244 (DECL-TABL/1 TOK-VIRGULE EXPRESSION
                     TOK-CRODROITE)
  (DECLARE (IGNORE TOK-VIRGULE TOK-CRODROITE))
  (SNOC DECL-TABL/1 EXPRESSION))

(DEFUN DECL-TABL245 (DECL-TABL/1 TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CRODROITE))
  (PROGN DECL-TABL/1))

(DEFUN LISTE-DECL-TABL245 (LISTE-DECL-TABL TOK-VIRGULE DECL-TABL)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-DECL-TABL DECL-TABL))

(DEFUN LISTE-DECL-TABL246 (DECL-TABL) (LIST DECL-TABL))

(DEFUN DECL-TABLEAU246 (TOK-TABLEAU LISTE-DECL-TABL)
  (DECLARE (IGNORE TOK-TABLEAU))
  (CONS :TABLEAU LISTE-DECL-TABL))

(DEFUN DECL-CHAINE246 (TOK-CHAINE LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-CHAINE))
  (CONS :CHAINE LISTE-IDENTIFICATEUR))

(DEFUN LIBERATION246 (TOK-LIBERER LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-LIBERER))
  (CONS :LIBERER LISTE-IDENTIFICATEUR))

(DEFUN LISTE-INSTRUCTION246 (LISTE-INSTRUCTION TOK-PTVIRG
                             INSTRUCTION)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INSTRUCTION INSTRUCTION))

(DEFUN LISTE-INSTRUCTION247 (INSTRUCTION TOK-PTVIRG TOK-COMMENTAIRE)
  (DECLARE (IGNORE TOK-PTVIRG))
  (LIST INSTRUCTION (LIST :COMMENTAIRE TOK-COMMENTAIRE)))

(DEFUN LISTE-INSTRUCTION248 (INSTRUCTION) (LIST INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL248 (LISTE-INST-OU-DECL
                              TOK-PTVIRG
                              INSTRUCTION)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INST-OU-DECL INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL249 (LISTE-INST-OU-DECL TOK-PTVIRG DECL)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INST-OU-DECL DECL))

(DEFUN LISTE-INST-OU-DECL250 (INSTRUCTION) (LIST INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL251 (DECL) (LIST DECL))

(DEFUN LISTE-INST-OU-DECL252 (TOK-COMMENTAIRE)
  (LIST :COMMENTAIRE TOK-COMMENTAIRE))

(DEFUN LIGNE-DECL-PROCEDURE/0252 (TOK-NUMERO DECL-PROCEDURE)
  (LIST :LIGNE-PROGRAMME
        TOK-NUMERO
        (LIST :DECL-PROCEDURE DECL-PROCEDURE)))

(DEFUN LIGNE-PROGRAMME252 (TOK-NUMERO LISTE-INST-OU-DECL)
  (LIST* :LIGNE-PROGRAMME TOK-NUMERO LISTE-INST-OU-DECL))

(DEFUN LIGNE-PROGRAMME253 (TOK-NUMERO TOK-COMMENTAIRE)
  (LIST :LIGNE-PROGRAMME
        TOK-NUMERO
        (LIST :COMMENTAIRE TOK-COMMENTAIRE)))

(DEFUN LIGNE-PROGRAMME254 (LIGNE-DECL-PROCEDURE/0 TOK-PTVIRG
                           LISTE-INST-OU-DECL)
  (DECLARE (IGNORE TOK-PTVIRG))
  (NCONC LIGNE-DECL-PROCEDURE/0 LISTE-INST-OU-DECL))

(DEFUN CONDITION254 (TOK-NON CONDITION)
  (DECLARE (IGNORE TOK-NON))
  (LIST :NON CONDITION))

(DEFUN CONDITION255 (TOK-PARGAUCHE DISJONCTION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (PROGN DISJONCTION))

(DEFUN CONDITION256 (EXPRESSION.1 TOK-LT EXPRESSION.2)
  (DECLARE (IGNORE TOK-LT))
  (LIST :LT EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION257 (EXPRESSION.1 TOK-LE EXPRESSION.2)
  (DECLARE (IGNORE TOK-LE))
  (LIST :LE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION258 (EXPRESSION.1 TOK-NE EXPRESSION.2)
  (DECLARE (IGNORE TOK-NE))
  (LIST :NE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION259 (EXPRESSION.1 TOK-EQ EXPRESSION.2)
  (DECLARE (IGNORE TOK-EQ))
  (LIST :EG EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION260 (EXPRESSION.1 TOK-GT EXPRESSION.2)
  (DECLARE (IGNORE TOK-GT))
  (LIST :GT EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION261 (EXPRESSION.1 TOK-GE EXPRESSION.2)
  (DECLARE (IGNORE TOK-GE))
  (LIST :GE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONJONCTION261 (CONJONCTION TOK-ET CONDITION)
  (DECLARE (IGNORE TOK-ET))
  (LIST :ET CONJONCTION CONDITION))

(DEFUN CONJONCTION262 (CONDITION) (PROGN CONDITION))

(DEFUN DISJONCTION262 (DISJONCTION TOK-OU CONJONCTION)
  (DECLARE (IGNORE TOK-OU))
  (LIST :OU DISJONCTION CONJONCTION))

(DEFUN DISJONCTION263 (CONJONCTION) (PROGN CONJONCTION))

(DEFUN LISTE-IDENTIFICATEUR263 (LISTE-IDENTIFICATEUR
                                TOK-VIRGULE
                                IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-IDENTIFICATEUR IDENTIFICATEUR))

(DEFUN LISTE-IDENTIFICATEUR264 (IDENTIFICATEUR) (LIST IDENTIFICATEUR))

(DEFUN LISTE-EXPRESSION264 (LISTE-EXPRESSION TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-EXPRESSION EXPRESSION))

(DEFUN LISTE-EXPRESSION265 (EXPRESSION) (LIST EXPRESSION))

(DEFUN SIMPLE265 (TOK-SI DISJONCTION TOK-ALORS EXPRESSION.1 TOK-SINON
                  EXPRESSION.2)
  (DECLARE (IGNORE TOK-SI TOK-ALORS TOK-SINON))
  (LIST :XI DISJONCTION EXPRESSION.1 EXPRESSION.2))

(DEFUN SIMPLE266 (IDENTIFICATEUR TOK-PARGAUCHE TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (LIST :FONCTION IDENTIFICATEUR))

(DEFUN SIMPLE267 (IDENTIFICATEUR TOK-PARGAUCHE LISTE-EXPRESSION
                  TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (LIST* :FONCTION IDENTIFICATEUR LISTE-EXPRESSION))

(DEFUN SIMPLE268 (TOK-LITCHAINE) (PROGN TOK-LITCHAINE))

(DEFUN SIMPLE269 (TOK-PARGAUCHE EXPRESSION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (PROGN EXPRESSION))

(DEFUN SIMPLE270 (TOK-NOMBRE) (PROGN TOK-NOMBRE))

(DEFUN SIMPLE271 (TOK-NUMERO) (PROGN TOK-NUMERO))

(DEFUN FACTEUR271 (FACTEUR TOK-PUISSANCE SIMPLE)
  (DECLARE (IGNORE TOK-PUISSANCE))
  (LIST :PUISSANCE FACTEUR SIMPLE))

(DEFUN TERME271 (TERME TOK-FOIS FACTEUR)
  (DECLARE (IGNORE TOK-FOIS))
  (LIST :FOIS TERME FACTEUR))

(DEFUN TERME272 (TERME TOK-DIVISE FACTEUR)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :DIVISE TERME FACTEUR))

(DEFUN EXPRESSION272 (TOK-MOINS TERME)
  (DECLARE (IGNORE TOK-MOINS))
  (LIST :NEG TERME))

(DEFUN EXPRESSION273 (EXPRESSION TOK-MOINS TERME)
  (DECLARE (IGNORE TOK-MOINS))
  (LIST :MOINS EXPRESSION TERME))

(DEFUN EXPRESSION274 (EXPRESSION TOK-PLUS TERME)
  (DECLARE (IGNORE TOK-PLUS))
  (LIST :PLUS EXPRESSION TERME))

(DEFUN EXPRESSION275 (EXPRESSION TOK-CONCAT TERME)
  (DECLARE (IGNORE TOK-CONCAT))
  (LIST :CONCAT EXPRESSION TERME))

(DEFUN IDENTIFICATEUR275 (TOK-IDENTIFICATEUR)
  (PROGN TOK-IDENTIFICATEUR))

(DEFUN AFFIC/FORMAT275 (TOK-AFFIC FORMAT)
  (DECLARE (IGNORE TOK-AFFIC))
  (LIST :AFFICHER FORMAT))

(DEFUN AFFIC275 (AFFIC/FORMAT LISTE-EXPRESSION)
  (NCONC AFFIC/FORMAT LISTE-EXPRESSION))

(DEFUN AFFIC276 (TOK-AFFIC LISTE-EXPRESSION)
  (DECLARE (IGNORE TOK-AFFIC))
  (LIST* :AFFICHER NIL LISTE-EXPRESSION))

(DEFUN START276 (LISTE-INSTRUCTION)
  (CONS :LISTE-INSTRUCTION LISTE-INSTRUCTION))

(DEFUN START277 (AFFIC) (LIST :LISTE-INSTRUCTION AFFIC))

(DEFUN START278 (TOK-ERREUR) (PROGN TOK-ERREUR))

(DEFUN START279 () (PROGN NIL))
