...
(DEFUN EXECUTER/178 (TOK-EXECUTER EXPRESSION)
  (DECLARE (IGNORE TOK-EXECUTER))
  (LIST :EXECUTER EXPRESSION))

(DEFUN EXECUTER78 (EXECUTER/1 TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC EXECUTER/1 EXPRESSION))

(DEFUN SUPPRIMER/178 (TOK-SUPPRIMER EXPRESSION)
  (DECLARE (IGNORE TOK-SUPPRIMER))
  (LIST :SUPPRIMER EXPRESSION))

(DEFUN SUPPRIMER78 (SUPPRIMER/1 TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC SUPPRIMER/1 EXPRESSION))

(DEFUN CHARGER/178 (TOK-CHARGER IDENTIFICATEUR TOK-VIRGULE
...
(DEFUN CHARGER78 (CHARGER/1 TOK-VIRGULE IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC CHARGER/1 IDENTIFICATEUR))

(DEFUN GARER78 (TOK-GARER IDENTIFICATEUR TOK-VIRGULE EXPRESSION.1
...
(DEFUN APPEL/178 (IDENTIFICATEUR TOK-PARGAUCHE)
  (DECLARE (IGNORE TOK-PARGAUCHE))
  (LIST :APPEL IDENTIFICATEUR))

(DEFUN APPEL78 (APPEL/1 LISTE-EXPRESSION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (NCONC APPEL/1 LISTE-EXPRESSION))

(DEFUN APPEL79 (APPEL/1 TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (PROGN APPEL/1))

(DEFUN RESULTAT79 (TOK-RESULTAT EXPRESSION)
  (DECLARE (IGNORE TOK-RESULTAT))
  (LIST :RESULTAT EXPRESSION))

(DEFUN RETOUR79 (TOK-RETOUR)
  (DECLARE (IGNORE TOK-RETOUR))
  (LIST :RETOUR))

(DEFUN RETOUR80 (TOK-RETOUR TOK-EN EXPRESSION)
  (DECLARE (IGNORE TOK-RETOUR TOK-EN))
  (LIST :RETOUR-EN EXPRESSION))

(DEFUN FAIRE-POUR80 (TOK-FAIRE TOK-NUMERO TOK-POUR IDENTIFICATEUR
                     TOK-FLECHE EXPRESSION)
  (DECLARE (IGNORE TOK-FAIRE TOK-POUR TOK-FLECHE))
  (LIST TOK-NUMERO IDENTIFICATEUR EXPRESSION))

(DEFUN FAIRE-POUR-PAS80 (FAIRE-POUR TOK-PAS EXPRESSION)
  (DECLARE (IGNORE TOK-PAS))
  (SNOC FAIRE-POUR EXPRESSION))

(DEFUN FAIRE-POUR-PAS81 (FAIRE-POUR) (SNOC FAIRE-POUR NIL))

(DEFUN FAIRE-TANT-QUE81 (FAIRE-POUR-PAS TOK-TANT TOK-QUE DISJONCTION)
  (DECLARE (IGNORE TOK-TANT TOK-QUE))
  (CONS :FAIRE-TANT-QUE (SNOC FAIRE-POUR-PAS DISJONCTION)))

(DEFUN FAIRE-JUSQU-A81 (FAIRE-POUR-PAS TOK-JUSQUA EXPRESSION)
  (DECLARE (IGNORE TOK-JUSQUA))
  (CONS :FAIRE-JUSQU-A (SNOC FAIRE-POUR-PAS EXPRESSION)))

(DEFUN DEBUT-FIN81 (TOK-DEBUT LISTE-INST-OU-DECL TOK-FIN)
  (DECLARE (IGNORE TOK-DEBUT TOK-FIN))
  (CONS :DEBUT LISTE-INST-OU-DECL))

(DEFUN PAUSE81 (TOK-PAUSE) (DECLARE (IGNORE TOK-PAUSE)) (LIST :PAUSE))

(DEFUN TERMINER81 (TOK-TERMINER)
  (DECLARE (IGNORE TOK-TERMINER))
  (LIST :TERMINER))

(DEFUN SI-ALORS81 (TOK-SI DISJONCTION TOK-ALORS INSTRUCTION)
  (DECLARE (IGNORE TOK-SI TOK-ALORS))
  (LIST :SI DISJONCTION INSTRUCTION))

(DEFUN SI-ALORS-SINON81 (SI-ALORS TOK-SINON INSTRUCTION)
  (DECLARE (IGNORE TOK-SINON))
  (SNOC SI-ALORS INSTRUCTION))

(DEFUN ALLER-EN81 (TOK-ALLER TOK-EN EXPRESSION)
  (DECLARE (IGNORE TOK-ALLER TOK-EN))
  (LIST :ALLER-EN EXPRESSION))

(DEFUN SPEC-REP81 (TOK-FOIS)
  (DECLARE (IGNORE TOK-FOIS))
  (LIST :REP-VAR))

(DEFUN SPEC-REP-NUM81 (TOK-NUMERO) (LIST :REP TOK-NUMERO))

(DEFUN SPECIFICATION81 (TOK-LITCHAINE)
  (LIST :SPEC-CHAINE '(:REP-1) TOK-LITCHAINE))

(DEFUN SPECIFICATION82 (TOK-DIVISE)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :SPEC-SLASH '(:REP-1)))

(DEFUN SPECIFICATION83 (TOK-X)
  (DECLARE (IGNORE TOK-X))
  (LIST :SPEC-SPACE '(:REP-1)))

(DEFUN SPECIFICATION84 (TOK-C)
  (DECLARE (IGNORE TOK-C))
  (LIST :SPEC-CR '(:REP-1)))

(DEFUN SPECIFICATION85 (TOK-L)
  (DECLARE (IGNORE TOK-L))
  (LIST :SPEC-NL '(:REP-1)))

(DEFUN SPECIFICATION86 (TOK-U)
  (DECLARE (IGNORE TOK-U))
  (LIST :SPEC-U '(:REP-1)))

(DEFUN SPECIFICATION87 (TOK-F TOK-NUMERO.1 TOK-POINT TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-F TOK-POINT))
  (LIST :SPEC-F '(:REP-1) TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION88 (TOK-E TOK-NUMERO.1 TOK-POINT TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-E TOK-POINT))
  (LIST :SPEC-E '(:REP-1) TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION89 (SPEC-REP TOK-LITCHAINE)
  (LIST :SPEC-CHAINE SPEC-REP TOK-LITCHAINE))

(DEFUN SPECIFICATION90 (SPEC-REP TOK-DIVISE)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :SPEC-SLASH SPEC-REP))

(DEFUN SPECIFICATION91 (SPEC-REP TOK-X)
  (DECLARE (IGNORE TOK-X))
  (LIST :SPEC-SPACE SPEC-REP))

(DEFUN SPECIFICATION92 (SPEC-REP TOK-C)
  (DECLARE (IGNORE TOK-C))
  (LIST :SPEC-CR SPEC-REP))

(DEFUN SPECIFICATION93 (SPEC-REP TOK-L)
  (DECLARE (IGNORE TOK-L))
  (LIST :SPEC-NL SPEC-REP))

(DEFUN SPECIFICATION94 (SPEC-REP-NUM TOK-U)
  (DECLARE (IGNORE TOK-U))
  (LIST :SPEC-U SPEC-REP-NUM))

(DEFUN SPECIFICATION95 (SPEC-REP-NUM TOK-F TOK-NUMERO.1 TOK-POINT
                        TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-F TOK-POINT))
  (LIST :SPEC-F SPEC-REP-NUM TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN SPECIFICATION96 (SPEC-REP-NUM TOK-E TOK-NUMERO.1 TOK-POINT
                        TOK-NUMERO.2)
  (DECLARE (IGNORE TOK-E TOK-POINT))
  (LIST :SPEC-E SPEC-REP-NUM TOK-NUMERO.1 TOK-NUMERO.2))

(DEFUN LISTE-SPEC96 (LISTE-SPEC TOK-VIRGULE SPECIFICATION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-SPEC SPECIFICATION))

(DEFUN LISTE-SPEC97 (SPECIFICATION) (LIST SPECIFICATION))

(DEFUN FORMAT97 (TOK-CROGAUCHE LISTE-SPEC TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CROGAUCHE TOK-CRODROITE))
  (PROGN LISTE-SPEC))

(DEFUN AFFICHER/FORMAT97 (TOK-AFFICHER FORMAT)
  (DECLARE (IGNORE TOK-AFFICHER))
  (LIST :AFFICHER FORMAT))

(DEFUN AFFICHER97 (TOK-AFFICHER LISTE-EXPRESSION)
  (DECLARE (IGNORE TOK-AFFICHER))
  (LIST* :AFFICHER NIL LISTE-EXPRESSION))

(DEFUN AFFICHER98 (AFFICHER/FORMAT LISTE-EXPRESSION)
  (NCONC AFFICHER/FORMAT LISTE-EXPRESSION))

(DEFUN LIRE98 (TOK-LIRE LISTE-REFERENCE)
  (DECLARE (IGNORE TOK-LIRE))
  (CONS :LIRE LISTE-REFERENCE))

(DEFUN AFFECTATION98 (REFERENCE TOK-FLECHE EXPRESSION)
  (DECLARE (IGNORE TOK-FLECHE))
  (LIST :AFFECTATION REFERENCE EXPRESSION))

(DEFUN LISTE-REFERENCE98 (LISTE-REFERENCE TOK-VIRGULE REFERENCE)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-REFERENCE REFERENCE))

(DEFUN LISTE-REFERENCE99 (REFERENCE) (LIST REFERENCE))

(DEFUN REFERENCE/VECTEUR99 (IDENTIFICATEUR TOK-CROGAUCHE EXPRESSION)
  (DECLARE (IGNORE TOK-CROGAUCHE))
  (LIST :AREF IDENTIFICATEUR EXPRESSION))

(DEFUN REFERENCE99 (REFERENCE/VECTEUR TOK-VIRGULE EXPRESSION
                    TOK-CRODROITE)
  (DECLARE (IGNORE TOK-VIRGULE TOK-CRODROITE))
  (SNOC REFERENCE/VECTEUR EXPRESSION))

(DEFUN REFERENCE100 (REFERENCE/VECTEUR TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CRODROITE))
  (PROGN REFERENCE/VECTEUR))

(DEFUN REFERENCE101 (IDENTIFICATEUR) (LIST :VREF IDENTIFICATEUR))

(DEFUN DECL-LOCAL101 (TOK-LOCAL LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-LOCAL))
  (PROGN LISTE-IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/TETE101 (TOK-PROCEDURE
                               IDENTIFICATEUR
                               TOK-PARGAUCHE)
  (DECLARE (IGNORE TOK-PROCEDURE TOK-PARGAUCHE))
  (LIST :PROCEDURE IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/N101 (DECL-PROCEDURE/TETE LISTE-IDENTIFICATEUR
                            TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (SNOC DECL-PROCEDURE/TETE LISTE-IDENTIFICATEUR))

(DEFUN DECL-PROCEDURE/0101 (DECL-PROCEDURE/TETE TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARDROITE))
  (SNOC DECL-PROCEDURE/TETE NIL))

(DEFUN DECL-PROCEDURE101 (DECL-PROCEDURE/0)
  (SNOC DECL-PROCEDURE/0 NIL))

(DEFUN DECL-PROCEDURE102 (DECL-PROCEDURE/0 DECL-LOCAL)
  (SNOC DECL-PROCEDURE/0 DECL-LOCAL))

(DEFUN DECL-PROCEDURE103 (DECL-PROCEDURE/N)
  (SNOC DECL-PROCEDURE/N NIL))

(DEFUN DECL-PROCEDURE104 (DECL-PROCEDURE/N DECL-LOCAL)
  (SNOC DECL-PROCEDURE/N DECL-LOCAL))

(DEFUN DECL-TABL/1104 (IDENTIFICATEUR TOK-CROGAUCHE EXPRESSION)
  (DECLARE (IGNORE TOK-CROGAUCHE))
  (LIST :ADECL IDENTIFICATEUR EXPRESSION))

(DEFUN DECL-TABL104 (DECL-TABL/1 TOK-VIRGULE EXPRESSION
                     TOK-CRODROITE)
  (DECLARE (IGNORE TOK-VIRGULE TOK-CRODROITE))
  (SNOC DECL-TABL/1 EXPRESSION))

(DEFUN DECL-TABL105 (DECL-TABL/1 TOK-CRODROITE)
  (DECLARE (IGNORE TOK-CRODROITE))
  (PROGN DECL-TABL/1))

(DEFUN LISTE-DECL-TABL105 (LISTE-DECL-TABL TOK-VIRGULE DECL-TABL)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-DECL-TABL DECL-TABL))

(DEFUN LISTE-DECL-TABL106 (DECL-TABL) (LIST DECL-TABL))

(DEFUN DECL-TABLEAU106 (TOK-TABLEAU LISTE-DECL-TABL)
  (DECLARE (IGNORE TOK-TABLEAU))
  (CONS :TABLEAU LISTE-DECL-TABL))

(DEFUN DECL-CHAINE106 (TOK-CHAINE LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-CHAINE))
  (CONS :CHAINE LISTE-IDENTIFICATEUR))

(DEFUN LIBERATION106 (TOK-LIBERER LISTE-IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-LIBERER))
  (CONS :LIBERER LISTE-IDENTIFICATEUR))

(DEFUN LISTE-INSTRUCTION106 (LISTE-INSTRUCTION TOK-PTVIRG
                             INSTRUCTION)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INSTRUCTION INSTRUCTION))

(DEFUN LISTE-INSTRUCTION107 (INSTRUCTION TOK-PTVIRG TOK-COMMENTAIRE)
  (DECLARE (IGNORE TOK-PTVIRG))
  (LIST INSTRUCTION (LIST :COMMENTAIRE TOK-COMMENTAIRE)))

(DEFUN LISTE-INSTRUCTION108 (INSTRUCTION) (LIST INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL108 (LISTE-INST-OU-DECL
                              TOK-PTVIRG
                              INSTRUCTION)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INST-OU-DECL INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL109 (LISTE-INST-OU-DECL TOK-PTVIRG DECL)
  (DECLARE (IGNORE TOK-PTVIRG))
  (SNOC LISTE-INST-OU-DECL DECL))

(DEFUN LISTE-INST-OU-DECL110 (INSTRUCTION) (LIST INSTRUCTION))

(DEFUN LISTE-INST-OU-DECL111 (DECL) (LIST DECL))

(DEFUN LISTE-INST-OU-DECL112 (TOK-COMMENTAIRE)
  (LIST :COMMENTAIRE TOK-COMMENTAIRE))

(DEFUN LIGNE-DECL-PROCEDURE/0112 (TOK-NUMERO DECL-PROCEDURE)
  (LIST :LIGNE-PROGRAMME
        TOK-NUMERO
        (LIST :DECL-PROCEDURE DECL-PROCEDURE)))

(DEFUN LIGNE-PROGRAMME112 (TOK-NUMERO LISTE-INST-OU-DECL)
  (LIST* :LIGNE-PROGRAMME TOK-NUMERO LISTE-INST-OU-DECL))

(DEFUN LIGNE-PROGRAMME113 (TOK-NUMERO TOK-COMMENTAIRE)
  (LIST :LIGNE-PROGRAMME
        TOK-NUMERO
        (LIST :COMMENTAIRE TOK-COMMENTAIRE)))

(DEFUN LIGNE-PROGRAMME114 (LIGNE-DECL-PROCEDURE/0 TOK-PTVIRG
                           LISTE-INST-OU-DECL)
  (DECLARE (IGNORE TOK-PTVIRG))
  (NCONC LIGNE-DECL-PROCEDURE/0 LISTE-INST-OU-DECL))

(DEFUN CONDITION114 (TOK-NON CONDITION)
  (DECLARE (IGNORE TOK-NON))
  (LIST :NON CONDITION))

(DEFUN CONDITION115 (TOK-PARGAUCHE DISJONCTION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (PROGN DISJONCTION))

(DEFUN CONDITION116 (EXPRESSION.1 TOK-LT EXPRESSION.2)
  (DECLARE (IGNORE TOK-LT))
  (LIST :LT EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION117 (EXPRESSION.1 TOK-LE EXPRESSION.2)
  (DECLARE (IGNORE TOK-LE))
  (LIST :LE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION118 (EXPRESSION.1 TOK-NE EXPRESSION.2)
  (DECLARE (IGNORE TOK-NE))
  (LIST :NE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION119 (EXPRESSION.1 TOK-EQ EXPRESSION.2)
  (DECLARE (IGNORE TOK-EQ))
  (LIST :EG EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION120 (EXPRESSION.1 TOK-GT EXPRESSION.2)
  (DECLARE (IGNORE TOK-GT))
  (LIST :GT EXPRESSION.1 EXPRESSION.2))

(DEFUN CONDITION121 (EXPRESSION.1 TOK-GE EXPRESSION.2)
  (DECLARE (IGNORE TOK-GE))
  (LIST :GE EXPRESSION.1 EXPRESSION.2))

(DEFUN CONJONCTION121 (CONJONCTION TOK-ET CONDITION)
  (DECLARE (IGNORE TOK-ET))
  (LIST :ET CONJONCTION CONDITION))

(DEFUN CONJONCTION122 (CONDITION) (PROGN CONDITION))

(DEFUN DISJONCTION122 (DISJONCTION TOK-OU CONJONCTION)
  (DECLARE (IGNORE TOK-OU))
  (LIST :OU DISJONCTION CONJONCTION))

(DEFUN DISJONCTION123 (CONJONCTION) (PROGN CONJONCTION))

(DEFUN LISTE-IDENTIFICATEUR123 (LISTE-IDENTIFICATEUR
                                TOK-VIRGULE
                                IDENTIFICATEUR)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-IDENTIFICATEUR IDENTIFICATEUR))

(DEFUN LISTE-IDENTIFICATEUR124 (IDENTIFICATEUR) (LIST IDENTIFICATEUR))

(DEFUN LISTE-EXPRESSION124 (LISTE-EXPRESSION TOK-VIRGULE EXPRESSION)
  (DECLARE (IGNORE TOK-VIRGULE))
  (SNOC LISTE-EXPRESSION EXPRESSION))

(DEFUN LISTE-EXPRESSION125 (EXPRESSION) (LIST EXPRESSION))

(DEFUN SIMPLE125 (TOK-SI DISJONCTION TOK-ALORS EXPRESSION.1 TOK-SINON
                  EXPRESSION.2)
  (DECLARE (IGNORE TOK-SI TOK-ALORS TOK-SINON))
  (LIST :XI DISJONCTION EXPRESSION.1 EXPRESSION.2))

(DEFUN SIMPLE126 (IDENTIFICATEUR TOK-PARGAUCHE TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (LIST :FONCTION IDENTIFICATEUR))

(DEFUN SIMPLE127 (IDENTIFICATEUR TOK-PARGAUCHE LISTE-EXPRESSION
                  TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (LIST* :FONCTION IDENTIFICATEUR LISTE-EXPRESSION))

(DEFUN SIMPLE128 (TOK-LITCHAINE) (PROGN TOK-LITCHAINE))

(DEFUN SIMPLE129 (TOK-PARGAUCHE EXPRESSION TOK-PARDROITE)
  (DECLARE (IGNORE TOK-PARGAUCHE TOK-PARDROITE))
  (PROGN EXPRESSION))

(DEFUN SIMPLE130 (TOK-NOMBRE) (PROGN TOK-NOMBRE))

(DEFUN SIMPLE131 (TOK-NUMERO) (PROGN TOK-NUMERO))

(DEFUN FACTEUR131 (FACTEUR TOK-PUISSANCE SIMPLE)
  (DECLARE (IGNORE TOK-PUISSANCE))
  (LIST :PUISSANCE FACTEUR SIMPLE))

(DEFUN TERME131 (TERME TOK-FOIS FACTEUR)
  (DECLARE (IGNORE TOK-FOIS))
  (LIST :FOIS TERME FACTEUR))

(DEFUN TERME132 (TERME TOK-DIVISE FACTEUR)
  (DECLARE (IGNORE TOK-DIVISE))
  (LIST :DIVISE TERME FACTEUR))

(DEFUN EXPRESSION132 (TOK-MOINS TERME)
  (DECLARE (IGNORE TOK-MOINS))
  (LIST :NEG TERME))

(DEFUN EXPRESSION133 (EXPRESSION TOK-MOINS TERME)
  (DECLARE (IGNORE TOK-MOINS))
  (LIST :MOINS EXPRESSION TERME))

(DEFUN EXPRESSION134 (EXPRESSION TOK-PLUS TERME)
  (DECLARE (IGNORE TOK-PLUS))
  (LIST :PLUS EXPRESSION TERME))

(DEFUN EXPRESSION135 (EXPRESSION TOK-CONCAT TERME)
  (DECLARE (IGNORE TOK-CONCAT))
  (LIST :CONCAT EXPRESSION TERME))

(DEFUN IDENTIFICATEUR135 (TOK-IDENTIFICATEUR)
  (PROGN TOK-IDENTIFICATEUR))

(DEFUN AFFIC/FORMAT135 (TOK-AFFIC FORMAT)
  (DECLARE (IGNORE TOK-AFFIC))
  (LIST :AFFICHER FORMAT))

(DEFUN AFFIC135 (AFFIC/FORMAT LISTE-EXPRESSION)
  (NCONC AFFIC/FORMAT LISTE-EXPRESSION))

(DEFUN AFFIC136 (TOK-AFFIC LISTE-EXPRESSION)
  (DECLARE (IGNORE TOK-AFFIC))
  (LIST* :AFFICHER NIL LISTE-EXPRESSION))

(DEFUN START136 (LISTE-INSTRUCTION)
  (CONS :LISTE-INSTRUCTION LISTE-INSTRUCTION))

(DEFUN START137 (AFFIC) (LIST :LISTE-INSTRUCTION AFFIC))

(DEFUN START138 (TOK-ERREUR) (PROGN TOK-ERREUR))

(DEFUN START139 () (PROGN NIL))
